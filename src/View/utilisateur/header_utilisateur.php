...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    <div class="android-header mdl-layout__header mdl-layout__header--waterfall">
        <div class="mdl-layout__header-row">
          <span class="android-title mdl-layout-title">
            <a href="Accueille_utilisateur.php"><img class="android-logo-image" src="../../../images/train-logo1.png"></a>
          </span>
    ...
    <div class="android-drawer mdl-layout__drawer">
        ...
        <nav class="mdl-navigation">
            ...
            <a class="mdl-navigation__link" href="Accueille_utilisateur.php">Accueille</a>
            <a class="mdl-navigation__link" href="Accueille_utilisateur.php">Contacter-nous</a>
